				...
				<div class='container_wrap footer_color' id='footer'>
					...
					<div class='container'>
						...
						do_action('avia_before_footer_columns');
						 ...
						 echo '<div id="footer-menu-bw" class="av-submenu-container socket_color  avia-builder-el-1  el_after_av_fullscreen  el_before_av_section  submenu-not-first container_wrap fullsize">';
					        wp_nav_menu($args);
					        echo '</div>';
